...
def get_config():
    ...
    model_location = './models/celeb_128/checkpoints/ckpt_0000392000.pt'
    model_config_location = './models/celeb_128/config/config_001.yaml'
    ...
    sampler.DPF_type = 1
    config.DPF_type = sampler.DPF_type
