...
def get_config():
    ...
    pianoroll_dataset_path = './dataset/pianoroll_dataset'
    model_location = './models/piano/checkpoints/ckpt_0000999999.pt'
    model_config_location = './models/piano/config/config_001.yaml'
